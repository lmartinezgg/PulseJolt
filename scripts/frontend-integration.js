 ...
 * This file demonstrates how to integrate Pulsejolt with a web frontend
 */

// For React/Vue/Angular applications
export class PulsejoltClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new PulsejoltClient(provider, contractAddress);
